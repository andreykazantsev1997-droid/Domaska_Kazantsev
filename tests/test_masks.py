...
def test_get_mask_card_number_varied(number_card, expected):
...
@pytest.mark.parametrize("number_account, expected", [("73654108430135874305", "**4305"),
                         ("7365 4108 4301 3587 4305", "**4305"),
                         ("7365410843013587", "**3587"),("3587", "**3587")])
def test_get_mask_account_varied(number_account, expected):
